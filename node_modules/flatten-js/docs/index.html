...
<div id="main">
    ...
    <section class="readme">
        <article><p><a href="https://badge.fury.io/js/flatten-js"><img src="https://badge.fury.io/js/flatten-js.svg" alt="npm version"></a>
<a href="https://travis-ci.org/alexbol99/flatten-js"><img src="https://travis-ci.org/alexbol99/flatten-js.svg?branch=master" alt="Build Status"></a>
<a href="https://coveralls.io/github/alexbol99/flatten-js?branch=master"><img src="https://coveralls.io/repos/github/alexbol99/flatten-js/badge.svg?branch=master" alt="Coverage Status"></a></p>
<h1>Javascript library for 2d geometry</h1><p>FlattenJS is a javascript library (about 50 Kb minified) for manipulating abstract geometrical shapes like point, vector, line, segment,
circle, arc and polygon. Shapes may be organized into Planar Set - searchable container which support spatial queries.</p>
<p>FlattenJS provides a lot of useful methods and algorithms like finding intersections, checking inclusion, calculating distance, apply
...
Some algorithms like <a href="https://github.com/alexbol99/flatten-boolean-op">Boolean Operations</a> and <a href="https://github.com/alexbol99/flatten-offset">Offset</a>,
implemented in separate packages.     </p>
<p>This library designed to work in any modern browser as well as under nodejs.
It is written in plain javascript with es6 syntax elements.
You can use es5 precompiled bundled package (added in v0.6.2) if you need to support old browsers.</p>
<p>TypeScript users may take advantage of static type checking with typescript definition file index.d.ts included into the package.</p>
<p>FlattenJS does not concern too much about visualization.
Anyway, all objects have svg() methods, that returns a string which may be inserted into SVG container. 
This works pretty well together with  <a href="https://d3js.org/">d3js</a> library. But it is definitely possible to create bridges to other graphic libraries.</p>
<p>The best way to start working with FlattenJS is to use awesome <a href="https://beta.observablehq.com/">Observable</a> javascript interactive notebooks.
There are several FlattenJS tutorials published in Observable Notebooks, see below.</p>
<p>Full documentation may be found <a href="https://alexbol99.github.io/flatten-js/index.html">here</a></p>
<h2>Installation</h2><pre class="prettyprint source"><code>npm install --save flatten-js</code></pre><h2>Usage</h2><p>Package may be required in different ways:</p>
<h5>Require as es6 module:</h5><pre class="prettyprint source lang-javascript"><code>    import Flatten from 'flatten-js';</code></pre><h5>Require as CommonJS package (nodejs)</h5><pre class="prettyprint source lang-javascript"><code>    const Flatten = require('flatten-js');</code></pre><h5>Require minified package precompiled into UMD format.</h5><p> <a href="https://beta.observablehq.com/">Observable</a> notebooks requires this format.</p>
<pre class="prettyprint source lang-javascript"><code>    const Flatten = require('flatten-js.umd.min.js');</code></pre><h5>Require precompiled to es5 package in Commonjs2 format.</h5><pre class="prettyprint source lang-javascript"><code>    import Flatten from &quot;flatten-js/dist/flatten.commonjs2&quot;</code></pre><p>This package is not minified.</p>
<p>This is the way you have to consume the package for <a href="https://reactjs.org/">React</a> library, at least when you use
<a href="https://github.com/facebook/create-react-app">create-react-library</a> starter kit:</p>
...
&quot;&quot;</code></pre><p>You can see example of <strong>FlattenJS + React</strong> usage in <a href="https://github.com/alexbol99/flatten-react-demo">flatten-react-demo</a> project.
It is live <a href="https://alexbol99.github.io/flatten-react-demo/">here</a>. 
Just clone it from the GitHub, install dependencies and start working using <em>npm start</em> or
compile it to production using <em>npm run build</em>.</p>
<h2>Example</h2><p>After module required, you can create some construction:</p>
<pre class="prettyprint source lang-javascript"><code>    // extract object creators
    ...
    let ip = s1.intersect(s2);</code></pre><p>You may test the code above also in <a href="https://npm.runkit.com/flatten-js">NPM RunKit</a></p>
<h2>Tutorials</h2><ol>
<li><a href="https://beta.observablehq.com/@alexbol99/flattenjs-tutorials-getting-started"><img src="https://user-images.githubusercontent.com/6965440/41164953-0e3700b6-6b45-11e8-982f-de3c5bc2012d.PNG" alt="Getting Started"></a></li>
<li><a href="https://beta.observablehq.com/@alexbol99/flattenjs-tutorials-messing-around"><img src="https://user-images.githubusercontent.com/6965440/41164955-0e6019ec-6b45-11e8-9501-1565ccd75e0d.PNG" alt="Messing Around"></a></li>
<li><a href="https://beta.observablehq.com/@alexbol99/flattenjs-tutorials-planar-set"><img src="https://user-images.githubusercontent.com/6965440/41164948-0dde3b66-6b45-11e8-8a1a-b70f4ad228c1.PNG" alt="Planar Set"></a></li>
<li><a href="https://beta.observablehq.com/@alexbol99/flattenjs-tutorials-polygons"><img src="https://user-images.githubusercontent.com/6965440/41164949-0e0ccd1e-6b45-11e8-9400-009c8ba6e7e3.PNG" alt="polygons"></a></li>
</ol>
<h2>Contacts</h2><p>Follow me on <a href="https://twitter.com/alex_bol_">Twitter</a></p></article>
    </section>
