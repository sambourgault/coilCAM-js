//work in progress, Grasshopper code below:
...
//     #print(rs.CurvePoints(a)[0])
//     #print(i)
//     curve = rs.OffsetCurve(a,centroid,i*thickness)
//     curves.append(rs.coercecurve(curve))
//     for p in rs.CurvePoints(curve):
//         path1.append(p)
//     #curves.append(curve)
//     #curve = rs.OffsetCurve(a, 
// #curves = rs.OffsetCurve(a,centroid,thickness)
// """

// """pp1 = path[0]
// pp2 = rs.CreatePoint(path[0].X-2*radius, path[0].Y, path[0].Z)
// srf = rs.AddPlanarSrf([a])
// geo = rs.coercegeometry(srf)
// path2 = []
// contours = Brep.CreateContourCurves(geo, pp1, pp2, thickness)
...
//     end = cc.PointAtNormalizedLength(1)
//     if switch:
//         path2.append(rs.CreatePoint(start.X, start.Y, start.Z + layerHeight))
//         path2.append(rs.CreatePoint(end.X, end.Y, end.Z + layerHeight))
//         switch = False
//     else:
//         path2.append(rs.CreatePoint(end.X, end.Y, end.Z + layerHeight))
//         path2.append(rs.CreatePoint(start.X, start.Y, start.Z + layerHeight))
