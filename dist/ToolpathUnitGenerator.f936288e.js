...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"coilcam-functions/setup/ToolpathUnitGenerator.js":[function(require,module,exports) {
function toolpathUnitGenerator(position, initialRadius, layerHeight, nbLayers, nbPointsInLayer, radiusShapingParameter, scaleShapingParameter, scalingRadiusShapingParameter, translateShapingParameter, rotateShapingParameter) {
  var path = [];
  var radsp = radiusShapingParameter.length === 0 ? new Array(nbPointsInLayer).fill(0) : radiusShapingParameter;
  var ssp = scaleShapingParameter.length === 0 ? new Array(nbLayers).fill(0) : scaleShapingParameter;
