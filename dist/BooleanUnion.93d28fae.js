...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/@flatten-js/core/dist/main.mjs":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ray = exports.polygon = exports.point = exports.multiline = exports.matrix = exports.line = exports.inversion = exports.default = exports.circle = exports.box = exports.arc = exports.Vector = exports.Utils = exports.SmartIntersections = exports.Segment = exports.Relations = exports.Ray = exports.Polygon = exports.Point = exports.PlanarSet = exports.OVERLAP_SAME = exports.OVERLAP_OPPOSITE = exports.OUTSIDE = exports.ORIENTATION = exports.Multiline = exports.Matrix = exports.Line = exports.Inversion = exports.INSIDE = exports.Face = exports.Errors = exports.Edge = exports.Distance = exports.Circle = exports.CW = exports.CCW = exports.Box = exports.BooleanOperations = exports.BOUNDARY = exports.Arc = void 0;
exports.ray_shoot = ray_shoot;
exports.vector = exports.segment = void 0;
/**
 * Global constant CCW defines counterclockwise direction of arc
 * @type {boolean}
 */
const CCW = exports.CCW = true;

/**
 * Global constant CW defines clockwise direction of arc
 * @type {boolean}
 */
const CW = exports.CW = false;
...
const INSIDE$2 = exports.INSIDE = 1;
const OUTSIDE$1 = exports.OUTSIDE = 0;
const BOUNDARY$1 = exports.BOUNDARY = 2;
const CONTAINS = 3;
const INTERLACE = 4;
const OVERLAP_SAME$1 = exports.OVERLAP_SAME = 1;
const OVERLAP_OPPOSITE$1 = exports.OVERLAP_OPPOSITE = 2;
...
var Utils$1 = exports.Utils = /*#__PURE__*/Object.freeze({
  __proto__: null,
  DECIMALS: DECIMALS,
  EQ: EQ,
  EQ_0: EQ_0,
...
var smart_intersections = exports.SmartIntersections = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
var BooleanOperations = exports.BooleanOperations = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
class SVGAttributes {
  ...
  toAttrString(key, value) {
    ...
    return value === null ? "".concat(SVGKey, " ") : "".concat(SVGKey, "=\"").concat(value.toString(), "\" ");
  }
...
var Relations = exports.Relations = /*#__PURE__*/Object.freeze({
  __proto__: null,
  contain: contain,
  cover: cover,
  covered: covered,
 ...
 * @type {Point}
 */
let Point$1 = exports.Point = class Point extends Shape {
  /**
  ...
  svg(attrs = {}) {
    ...
    return "\n<circle cx=\"".concat(this.x, "\" cy=\"").concat(this.y, "\" r=\"").concat(r, "\"\n            ").concat(convertToString({
      fill: "red",
      ...attrs
    }), " />");
  }
 ...
 * @type {Vector}
 */
let Vector$1 = exports.Vector = class Vector extends Shape {
  /**
...
class Segment extends Shape {
   ...
   */
  svg(attrs = {}) {
    return "\n<line x1=\"".concat(this.start.x, "\" y1=\"").concat(this.start.y, "\" x2=\"").concat(this.end.x, "\" y2=\"").concat(this.end.y, "\" ").concat(convertToString(attrs), " />");
  }
}
 ...
 * @type {Line}
 */
let Line$1 = exports.Line = class Line extends Shape {
  /**
 ...
 * @type {Circle}
 */
let Circle$1 = exports.Circle = class Circle extends Shape {
  /**
  ...
  scale(sx, sy) {
    ...
    if (!(this.pc.x === 0.0 && this.pc.y === 0.0)) throw Errors.OPERATION_IS_NOT_SUPPORTED;
   ...
   */
  svg(attrs = {}) {
    return "\n<circle cx=\"".concat(this.pc.x, "\" cy=\"").concat(this.pc.y, "\" r=\"").concat(this.r, "\"\n                ").concat(convertToString({
      fill: "none",
      ...attrs
    }), " />");
  }
...
class Box extends Shape {
  ...
  contains(shape) {
    ...
    if (shape instanceof Flatten.Arc) {
      return shape.vertices.every(vertex => this.contains(vertex)) && shape.toSegments().every(segment => intersectSegment2Arc(segment, shape).length === 0);
    }
  ...
  svg(attrs = {}) {
    ...
    return "\n<rect x=\"".concat(this.xmin, "\" y=\"").concat(this.ymin, "\" width=").concat(width, " height=").concat(height, "\n                ").concat(convertToString({
      fill: "none",
      ...attrs
    }), " />");
  }
...
class Inversion {
  ...
  static inversePoint(inversion_circle, point) {
    ...
    const len2 = v.dot(v);
    const reflected_point = Utils.EQ_0(len2) ? new Point(Number.POSITIVE_INFINITY, Number.POSITIVE_INFINITY) : inversion_circle.pc.translate(v.multiply(k2 / len2));
...
},{}],"coilcam-functions/boolean/BooleanUnion.js":[function(require,module,exports) {
"use strict";

var _core = _interopRequireDefault(require("@flatten-js/core"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
// /* eslint-disable no-unused-vars */
// import Flatten from '../../node_modules/@flatten-js/core/dist/main.mjs';

var point = _core.default.point,
  Polygon = _core.default.Polygon;
var unify = _core.default.BooleanOperations.unify;
var polygon4 = new Polygon([0.5]);
...
function union(path0, path1, radius) {
  ...
  var layers0 = getNumLayers(path0);
...
},{"@flatten-js/core":"node_modules/@flatten-js/core/dist/main.mjs"}],"../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","coilcam-functions/boolean/BooleanUnion.js"], null)
//# sourceMappingURL=/BooleanUnion.93d28fae.js.map